...
I am a first-year Ph.D. student in Mechanical Engineering at UC Berkeley, advised by [Prof. Koushil Sreenath](https://hybrid-robotics.berkeley.edu/koushil/) in the [Hybrid Robotics Group](https://hybrid-robotics.berkeley.edu/index.html). 

My research focuses on **Robotics**, **Reinforcement Learning (RL)** and **Generative Models**. 

I received my B.S. in Modern Mechanics from [USTC](https://en.ustc.edu.cn/).
